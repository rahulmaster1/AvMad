...
const ProfessionalReferences: NextPage<{
  ...
  <React.Fragment>
    ...
    Please provide three professional references to whom you are not related and who are not partners in your practice.
                </Alert>
                                                        ...
                                                        {Professional.map((field) => (
                                                            <Grid item xs={field.size} key={field.name}>
                                                                <CustomInput
                                                                    ...
                                                                    name={""}
                                                                    options={
                                                                        StateAndPractitionerMap[
                                                                        field.options as keyof typeof StateAndPractitionerMap
                                                                        ]
                                                                    }
