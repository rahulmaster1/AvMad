...
import AppProviderPractitionerFilter2 from 'form-fields/Apptrackerfiled/AppProviderPractitionerFilter2';
...
const AppProviderPractitionerTable: NextPage<{}> = () => {
    ...
    return (
        <>
            <form onSubmit={handleSubmit(onSubmit)} onSelect={() => autoSave()}>
                ...
                <Grid container spacing={2} sx={{ mt: 6, mb: 4 }}>
                    {AppProviderPractitionerFilter2.map((field) => (
...
export default AppProviderPractitionerTable;
