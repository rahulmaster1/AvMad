...
import ApptrackerClientFacilityPractitionerFilter2 from 'form-fields/Apptrackerfiled/ApptrackerClientFacilityPractitionerFilter2';
    ...
    return (
        <>
            <form onSubmit={handleSubmit(onSubmit)} onSelect={() => autoSave()}>
                ...
                <Alert severity="info">All practitioners in Client rishi2</Alert>
                <Grid container spacing={2} sx={{ mt: 2, mb: 2 }}>
                    {ApptrackerClientFacilityPractitionerFilter2.map((field) => (
