...
import ApptrackerClientProviderPractitionerFilter2 from 'form-fields/Apptrackerfiled/ApptrackerClientProviderPractitionerFilter2';
        ...
        <>
            <form onSubmit={handleSubmit(onSubmit)} onSelect={() => autoSave()}>
                ...
                <Grid container spacing={2} sx={{ mt: 2, mb: 2 }}>
                    {ApptrackerClientProviderPractitionerFilter2.map((field) => (
