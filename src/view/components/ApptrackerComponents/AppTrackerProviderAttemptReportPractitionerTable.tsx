...
import ApptrackerProviderAttemptReportPractitionerFilter2 from 'form-fields/Apptrackerfiled/ApptrackerProviderAttemptReportPractitionerFilter2';
    ...
    return (
        <>
            <form onSubmit={handleSubmit(onSubmit)} onSelect={() => autoSave()}>
                ...
                <Alert severity="info">All practitioners in Client rishi</Alert>
                <Grid container spacing={2} sx={{ mt: 2, mb: 2 }}>
                    {ApptrackerProviderAttemptReportPractitionerFilter2.map((field) => (
