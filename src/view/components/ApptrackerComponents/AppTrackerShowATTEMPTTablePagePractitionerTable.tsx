...
import ApptrackerShowATTEMPTTablePagePractitionerFilter2 from 'form-fields/Apptrackerfiled/ApptrackerShowATTEMPTTablePagePractitionerFilter2';
        ...
        <>
            <form onSubmit={handleSubmit(onSubmit)} onSelect={() => autoSave()}>
                ...
                <Grid container spacing={2} sx={{ mt: 2, mb: 2 }}>
                    {ApptrackerShowATTEMPTTablePagePractitionerFilter2.map((field) => (
