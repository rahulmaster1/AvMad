...
import ApptrackerShowFACILITYTableInTablePageFilter2 from 'form-fields/Apptrackerfiled/ApptrackerShowFACILITYTableInTablePageFilter2';
        ...
        <>
            <form onSubmit={handleSubmit(onSubmit)} onSelect={() => autoSave()}>
                ...
                <Grid container spacing={2} sx={{ mt: 2, mb: 2 }}>
                    {ApptrackerShowFACILITYTableInTablePageFilter2.map((field) => (
