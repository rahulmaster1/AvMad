...
import EmployementGapSoloInputField from 'form-fields/history/EmployementGapSoloInputField';
                            ...
                            <Grid item xs={12}>
                                <Accordion expanded={expanded.panel1} onChange={handleChangePanel('panel1')}>
                                    ...
                                    <AccordionDetails>
                                        <CustomInput
                                            control={control}
                                            fieldProps={EmployementGapSoloInputField.licenseFlagField}
                                            name={EmployementGapSoloInputField.licenseFlagField.name}
                                        />
                                        {watchLicenseFlag ? (
                                            <div>
