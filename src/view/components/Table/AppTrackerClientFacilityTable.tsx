            ...
            aria-label="custom pagination table">
                ...
                <TableHead>
                    ...
                    <StyledTableCell>                <input type="checkbox" />
                        ...
                        <StyledTableCell>FacilityID</StyledTableCell>
                        ...
                        <StyledTableCell>EncID</StyledTableCell>
                        <StyledTableCell>	Facility Type</StyledTableCell>
                        <StyledTableCell>Npi</StyledTableCell>
                        <StyledTableCell>	Tin</StyledTableCell>
                        <StyledTableCell>Mail Address 1</StyledTableCell>
                        <StyledTableCell>Mail Address 2</StyledTableCell>
                        <StyledTableCell>Mail City</StyledTableCell>
                        <StyledTableCell>Mail State</StyledTableCell>
                        <StyledTableCell>Mail Country</StyledTableCell>
                        <StyledTableCell>Mail Post Code</StyledTableCell>
                        <StyledTableCell>Mail Phone</StyledTableCell>
                        <StyledTableCell>Mail Fax</StyledTableCell>
                        <StyledTableCell>Mail Email</StyledTableCell>
