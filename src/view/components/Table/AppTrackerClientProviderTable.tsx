        ...
        <TableContainer component={Paper}>
            ...
            aria-label="custom pagination table">
                ...
                <TableHead>
                    ...
                    <StyledTableRow >
                    <StyledTableCell>                <input type="checkbox" />
</StyledTableCell>

                        <StyledTableCell>Client </StyledTableCell>
                        <StyledTableCell>ProviderID</StyledTableCell>
                        ...
                        <StyledTableCell>	Cred First Name</StyledTableCell>
                        <StyledTableCell>	Cred Middle Name</StyledTableCell>
                        <StyledTableCell>Cred Last Name</StyledTableCell>
                        <StyledTableCell>Encompass ID</StyledTableCell>
                        <StyledTableCell>	CAQHID	</StyledTableCell>
                        <StyledTableCell>		Practitioner Type	</StyledTableCell>

                        <StyledTableCell>Npi</StyledTableCell>
                        <StyledTableCell>	Birth Date</StyledTableCell>
                        <StyledTableCell>	Social Security Number</StyledTableCell>

                        <StyledTableCell>Prac Address 1</StyledTableCell>
                        <StyledTableCell>Prac Address 2</StyledTableCell>
                        <StyledTableCell>Prac City</StyledTableCell>
                        <StyledTableCell>Prac State</StyledTableCell>
                        <StyledTableCell>Prac Country</StyledTableCell>
                        <StyledTableCell>Prac Post Code</StyledTableCell>
                        <StyledTableCell>Prac Phone</StyledTableCell>
                        <StyledTableCell>Prac Fax</StyledTableCell>
                        <StyledTableCell>Prac Email</StyledTableCell>
                        <StyledTableCell>Provider Status</StyledTableCell>

                        <StyledTableCell>Complete Date</StyledTableCell>
                        <StyledTableCell>Complete Flag</StyledTableCell>
                        <StyledTableCell>Credential Status</StyledTableCell>

                        <StyledTableCell>File Due Date</StyledTableCell>
                        <StyledTableCell>Attestation Date</StyledTableCell>
                    ...
                    {(rowsPerPage > 0 ? rows.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage) : rows).map(
                        (row) => (
                            <StyledTableRow key={row.practitionerName}>
                                ...
                                <input type="checkbox" />                                </StyledTableCell>
                                <StyledTableCell component="th" scope="row">
                                ...
                                <StyledTableCell>12/31/2022</StyledTableCell>
                                <StyledTableCell>Completed</StyledTableCell>
                                <StyledTableCell>576-23-9204</StyledTableCell><StyledTableCell>12/31/2022</StyledTableCell>
                                <StyledTableCell>Completed</StyledTableCell>
                                <StyledTableCell>576-23-9204</StyledTableCell><StyledTableCell>12/31/2022</StyledTableCell>
                                <StyledTableCell>Completed</StyledTableCell>
                                <StyledTableCell>576-23-9204</StyledTableCell><StyledTableCell>12/31/2022</StyledTableCell>
